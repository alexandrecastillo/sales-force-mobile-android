package biz.belcorp.salesforce.modules.inspires.features.sync
...
import biz.belcorp.salesforce.modules.inspires.core.domain.usecase.SyncUseCase
import org.koin.core.KoinComponent
import org.koin.core.inject

class InspiresSyncManager : SyncManager(), KoinComponent {

    private val syncUseCase by inject<SyncUseCase>()
    override val groups = listOf(SyncGroup.HOME_ON_LOGIN)
    ...
    private fun publish(state: SyncState) {
        LiveDataBus.publish(EventSubject.INSPIRES_SYNC, state)
    }
