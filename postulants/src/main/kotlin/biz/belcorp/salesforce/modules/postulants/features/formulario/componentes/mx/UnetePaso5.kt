...
import kotlinx.android.synthetic.main.unete_mx_paso_5.view.*
...
class UnetePaso5(mContext: Context, view: UnetePaso5View) :
    ...
    override fun getLayout() = R.layout.unete_mx_paso_5

    companion object {
        private const val IMAGEN_IFE: Int = Constant.NUMERO_CERO
        private const val IMAGEN_PAGARE: Int = Constant.NUMERO_UNO
        private const val IMAGEN_CDD: Int = Constant.NUMERO_DOS
