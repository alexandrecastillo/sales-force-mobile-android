...
import kotlinx.android.synthetic.main.unete_ec_paso_5.view.*
...
class UnetePaso5(mContext: Context, view: UnetePaso5View) :
    ...
    override fun getLayout() = R.layout.unete_ec_paso_5
    ...
    companion object {
        ...
        private const val IMAGEN_PAGARE: Int = Constant.NUMERO_TRES
