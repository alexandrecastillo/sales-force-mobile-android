...
import kotlinx.android.synthetic.main.unete_cr_paso_5.view.*

@SuppressLint("ViewConstructor")
class UnetePaso5(context: Context, view: UnetePaso5View) :
        BaseUnetePaso<UnetePaso5View>(context, view), IUnetePaso5, UneteDocumentoAdapter.UneteDocumentoListener {
    ...
    companion object {
        ...
        private const val POS_8 = 8
    }

    var savedInstanceState: Bundle? = null

    override fun getLayout() = R.layout.unete_cr_paso_5
    ...
    override fun createModel(): PostulanteModel? {
        ...
        model.imagenContrato = documentos[POS_2].documento
        model.imagenPagare = documentos[POS_3].documento

        when (view.getModel().estadoBurocrediticio) {

            UneteEstadoCrediticio.CARTA_DESCARGO_Y_FIADOR.value.toString() -> {
                model.imagenDniAval = documentos[POS_4].documento
                model.imagenReciboOtraMarca = documentos[POS_5].documento
                model.imagenReciboPagoAval = documentos[POS_6].documento
                model.imagenCreditoAval = documentos[POS_7].documento
                model.imagenConstanciaLaboralAval = documentos[POS_8].documento
            ...
            UneteEstadoCrediticio.CONDICIONADA_CARTA_DESCARGO.value.toString() -> {
                model.imagenConstanciaLaboralAval = documentos[POS_4].documento
            }
        }
