...
import kotlinx.android.synthetic.main.unete_bo_paso_5.view.*
...
class UnetePaso5(mContext: Context, view: UnetePaso5View) :
    ...
    companion object {
        ...
        private const val IMAGEN_RECIBO_PAGO_AVAL: Int = Constant.NUMERO_DOS
        private const val IMAGEN_CONTRATO: Int = Constant.NUMERO_TRES
        private const val IMAGEN_DNI_AVAL: Int = Constant.NUMERO_CUATRO
        private const val IMAGEN_RECIBO_OTRA_MARCA: Int = Constant.NUMERO_CINCO
        private const val IMAGEN_CREDITO_AVAL: Int = Constant.NUMERO_SEIS
    }
    ...
    override fun getLayout() = R.layout.unete_bo_paso_5
    ...
    override fun createModel(): PostulanteModel {
        ...
        model.imagenReciboPagoAval = documentos[IMAGEN_RECIBO_PAGO_AVAL].documento
        model.imagenContrato = documentos[IMAGEN_CONTRATO].documento
        model.imagenDniAval = documentos[IMAGEN_DNI_AVAL].documento
