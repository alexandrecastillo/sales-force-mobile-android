...
import kotlinx.android.synthetic.main.unete_pa_paso_5.view.*
...
class UnetePaso5(mContext: Context, view: UnetePaso5View) :
    ...
    override fun getLayout() = R.layout.unete_pa_paso_5

    override fun createModel(): PostulanteModel? {
        val model = view.getModel()

        model.imagenIFE = documentos[POS_0].documento
        model.imagenReciboPagoAval = documentos[POS_1].documento
        model.imagenPagare = documentos[POS_2].documento
        model.imagenContrato = documentos[POS_3].documento
        model.imagenDniAval = documentos[POS_4].documento
        model.imagenCreditoAval = documentos[POS_5].documento
        model.imagenConstanciaLaboralAval = documentos[POS_6].documento
