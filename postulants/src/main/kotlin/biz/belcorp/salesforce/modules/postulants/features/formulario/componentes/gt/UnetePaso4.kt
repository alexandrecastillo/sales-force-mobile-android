...
import kotlinx.android.synthetic.main.unete_gt_paso_4.view.*
...
class UnetePaso4(mContext: Context, view: UnetePaso4View) :
    ...
    override fun getLayout() = R.layout.unete_gt_paso_4
    ...
    override fun initRestriction() {
        ...
        txtDireccion?.setRestriction(
            arrayOf(
                ...
                Filters.filterMaxLength(GT.DIR_MAX_DIGITOS)
            )
        )

        txtNombreReferencia?.setRestriction(Filters.filterLetters(GT.NOMBRE_APELLIDO_REF_MAX_DIGITOS))
        txtApellidoReferencia?.setRestriction(Filters.filterLetters(GT.NOMBRE_APELLIDO_REF_MAX_DIGITOS))
        txtTelefonoCelularReferencia?.setRestriction(Filters.filterNumber(GT.CELULAR_TELEFONO_MAX_DIGITOS))
        txtTelefonoFijoReferencia?.setRestriction(Filters.filterNumber(GT.CELULAR_TELEFONO_MAX_DIGITOS))

        txtNombreReferenciaNoFamiliar?.setRestriction(Filters.filterLetters(GT.NOMBRE_APELLIDO_REF_MAX_DIGITOS))
        txtApellidoReferenciaNoFamiliar?.setRestriction(Filters.filterLetters(GT.NOMBRE_APELLIDO_REF_MAX_DIGITOS))
        txtTelefonoCelularReferenciaNoFamiliar?.setRestriction(Filters.filterNumber(GT.CELULAR_TELEFONO_MAX_DIGITOS))
        txtTelefonoFijoReferenciaNoFamiliar?.setRestriction(Filters.filterNumber(GT.CELULAR_TELEFONO_MAX_DIGITOS))

        txtMetaMonto?.setRestriction(Filters.filterNumber(GT.MONTO_MAX_DIGITOS))
    }
    ...
    override fun initValidation() {
        ...
        txtTelefonoCelularReferencia?.addV(
            ...
            V(
                context, Validation.MIN_LENGTH, GT.CELULAR_TELEFONO_MAX_DIGITOS,
