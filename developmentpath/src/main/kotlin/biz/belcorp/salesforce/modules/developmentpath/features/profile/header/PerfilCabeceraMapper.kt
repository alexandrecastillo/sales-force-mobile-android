...
class PerfilCabeceraMapper() {
    ...
    private fun parsearDatosBasicos(info: ProfileInfo): PerfilCabeceraMapper {
    ...
    private fun crearPorTipo(persona: ProfileInfo, flagPdvPais: Boolean): PerfilCabeceraModel {
        return when (persona) {
            is ProfileInfo.DatoPersonaPc ->
                PerfilCabeceraModel.PosibleConsultora(
                    nombres = nombres,
                    iniciales = iniciales,
                    telefono = telefono,
            ...
            is ProfileInfo.DatoPersonaCo ->
                when (flagPdvPais) {
                    true ->
                        PerfilCabeceraModel.ConsultoraConNivel(
                        ...
                        PerfilCabeceraModel.Consultora(
                            segmento = persona.segmentoInterno,
                            tipo = persona.tipo,
                            nombres = nombres,
                            iniciales = iniciales,
            ...
            is ProfileInfo.DatoPersonaSe ->
                PerfilCabeceraModel.SociaEmpresaria(
            ...
            is ProfileInfo.DatoPersonaGz ->
                PerfilCabeceraModel.GerenteZona(
                    email = email,
                    iniciales = iniciales,
            ...
            is ProfileInfo.DatoPersonaGr ->
                PerfilCabeceraModel.GerenteRegion(
                    email = email,
                    iniciales = iniciales,
                    nombres = persona.contact.shortname,
                    telefono = telefono,
