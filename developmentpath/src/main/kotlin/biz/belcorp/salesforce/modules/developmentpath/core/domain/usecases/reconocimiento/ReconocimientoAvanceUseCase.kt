...
class ReconocimientoAvanceUseCase(
    ...
    fun ejecutar(request: Request) {
        val single = Single.create<Response> { emitter ->
            ...
            val reconocimientosHistoricos =
                ProgresoReconocimientos(reconocimientos, comportamientos)

            val response = Response(reconocimientosHistoricos.avancePorComportamiento)
    ...
    data class Response(val avances: List<ProgresoReconocimientos.Avance>)
