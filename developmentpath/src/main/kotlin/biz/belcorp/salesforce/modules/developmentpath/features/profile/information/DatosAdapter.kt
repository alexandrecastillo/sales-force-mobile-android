...
import biz.belcorp.salesforce.modules.developmentpath.widgets.etiqueta.GrupoEtiquetaLayout
import biz.belcorp.salesforce.modules.developmentpath.widgets.etiqueta.model.Grupo

class DatosAdapter : RecyclerView.Adapter<DatosAdapter.GrupoViewHolder>() {

    var grupos = emptyList<Grupo>()
