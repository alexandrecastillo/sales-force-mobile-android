...
import biz.belcorp.salesforce.modules.developmentpath.core.data.repository.dream_bp.COLLECTION_DELETE_KEY
import biz.belcorp.salesforce.modules.developmentpath.core.data.repository.dream_bp.FILTER_DELETE_KEY
import biz.belcorp.salesforce.modules.developmentpath.core.data.repository.dream_bp.FILTER_DELETE_TYPE
...
import biz.belcorp.salesforce.modules.developmentpath.core.data.repository.dream_bp.KEY_DATE_CREATED
...
class DreamDeleteBpQuery(private val request: DreamDeleteBpParams) : BaseQuery() {

    override val keyFunctionName = FUNCTION_KEY
    override val keyCollection = COLLECTION_DELETE_KEY
    override val keyFilter = FILTER_DELETE_KEY
    override val keyFilterType = FILTER_DELETE_TYPE
