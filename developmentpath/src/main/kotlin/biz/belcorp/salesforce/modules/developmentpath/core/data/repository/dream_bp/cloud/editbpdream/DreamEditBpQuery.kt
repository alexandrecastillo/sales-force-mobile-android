...
import biz.belcorp.salesforce.modules.developmentpath.core.data.repository.dream_bp.UPDATE_KEY
import biz.belcorp.salesforce.modules.developmentpath.core.data.repository.dream_bp.UPDATE_TYPE


class DreamEditBpQuery(private val request: DreamEditBpParams) : BaseQuery() {

    override val keyFunctionName = FUNCTION_KEY
    override val keyCollection = COLLECTION_UPDATE_KEY
    override val keyFilter = UPDATE_KEY
    override val keyFilterType = UPDATE_TYPE
