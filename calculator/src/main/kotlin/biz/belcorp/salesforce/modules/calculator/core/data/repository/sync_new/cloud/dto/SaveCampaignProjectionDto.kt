...
@Serializable
data class SaveCampaignProjectionDto(
    ...
    data class Capitalization(
        ...
        @SerialName(KEY_CAPI)
        val capitalizationProjected: CapitalizationProjected,
        @SerialName(KEY_GAIN_BY_POINTS)
        val gainByPoint: GainByPoint,
        @SerialName(KEY_GAIN)
        val gain: Gain,
    ) {
        @Serializable
        ...
        @Serializable
        data class CapitalizationProjected(
