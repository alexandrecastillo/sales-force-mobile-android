...
import biz.belcorp.salesforce.modules.calculator.core.data.repository.sync_new.FILTER_KEY
import biz.belcorp.salesforce.modules.calculator.core.data.repository.sync_new.FILTER_TYPE
...
import biz.belcorp.salesforce.modules.calculator.core.data.repository.sync_new.KEY_DATE_CREATED
import biz.belcorp.salesforce.modules.calculator.core.data.repository.sync_new.KEY_DATE_EDITED
...
import biz.belcorp.salesforce.modules.calculator.core.data.repository.sync_new.KEY_ORDER_UNITS_REAL
...
import biz.belcorp.salesforce.modules.calculator.core.data.repository.sync_new.KEY_RETENTION_6D6_LIST_RETENTION_REAL
...
class CampaignProjectionConsultantQuery(private val request: CampaignProjectionConsultantParams) :
    BaseQuery() {
                ...
                fieldObject(
                    ...
                    fieldObject(KEY_RETENTION_6D6) {
                        ...
                        field(KEY_RETENTION_6D6_LIST) {
                            ...
                            field(KEY_RETENTION_6D6_LIST_RETENTION_REAL)
                        }
                    }
