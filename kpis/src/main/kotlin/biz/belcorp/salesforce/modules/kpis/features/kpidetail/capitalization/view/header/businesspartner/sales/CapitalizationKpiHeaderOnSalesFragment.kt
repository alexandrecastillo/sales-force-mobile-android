package biz.belcorp.salesforce.modules.kpis.features.kpidetail.capitalization.view.header.businesspartner.sales
...
import kotlinx.android.synthetic.main.fragment_capitalization_kpi_header_on_sales.*

class CapitalizationKpiHeaderOnSalesFragment : BaseFragment() {
    ...
    override fun getLayout() = R.layout.fragment_capitalization_kpi_header_on_sales
    ...
    private fun setupPostulantView() {
        childFragmentManager.apply {
            beginTransaction().replaceOnce(
                flHeaderMultiProfilePostulantKpi.id,
                PostulantsKpiFragment().javaClass.simpleName,
    ...
    companion object {
        ...
        val TAG = CapitalizationKpiHeaderOnSalesFragment::javaClass.javaClass.simpleName

        fun newInstance() = CapitalizationKpiHeaderOnSalesFragment()
    }
