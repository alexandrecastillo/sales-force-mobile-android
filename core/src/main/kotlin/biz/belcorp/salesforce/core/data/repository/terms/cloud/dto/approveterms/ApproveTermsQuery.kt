...
import biz.belcorp.salesforce.core.data.repository.terms.cloud.OPERATION_APPROVED_NAME
import biz.belcorp.salesforce.core.data.repository.terms.cloud.VAR_APPROVED_TYPE_PARAMS
...
data class ApproveTermsQuery(private val params: ApproveRequestParams) : BaseQuery() {

    override val keyFunctionName = OPERATION_APPROVED_NAME
    override val keyFilter = VAR_KEY_PARAMS
    override val keyFilterType = VAR_APPROVED_TYPE_PARAMS
    override val keyCollection = KEY_APPROVED_TERMS
